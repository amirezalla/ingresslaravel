...
final class Core
{
    ...
    public function activateLicense(string $license, string $client): bool
    {
        ...
        $data = array('status' => true,'message' => 'Verified! Thanks for purchasing our product. NullCave.club', 'lic_response' => 'Valid');
    ...
    {
		return array('status'  => true,'message' => 'Verified! Thanks for purchasing our product. NullCave.club', 'lic_response' => 'Valid');
