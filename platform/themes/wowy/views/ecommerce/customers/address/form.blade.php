        ...
        {!! Form::open(['route' => $route]) !!}
            ...
            @if (EcommerceHelper::isUsingInMultipleCountries())
                <div class="form-group @if ($errors->has('country')) has-error @endif">
                    ...
                    <select name="country" required class="form-select square" id="country" data-type="country">
            ...
            <div class="form-group @if ($errors->has('state')) has-error @endif">
                ...
                @if (EcommerceHelper::loadCountriesStatesCitiesFromPluginLocation())
                    <select name="state" class="form-select" id="state" data-type="state" data-placeholder="{{ __('Select state...') }}" data-url="{{ route('ajax.states-by-country') }}">
            ...
            <div class="form-group @if ($errors->has('city')) has-error @endif">
                ...
                @if (EcommerceHelper::loadCountriesStatesCitiesFromPluginLocation())
                    <select name="city" class="form-select" id="city" data-type="city" data-placeholder="{{ __('Select city...') }}" data-url="{{ route('ajax.cities-by-state') }}">
